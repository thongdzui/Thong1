...
#random email
def randomString(nhapSoLuongkiTuVaoDiAThong):
    letters = string.ascii_lowercase
    return ''.join(random.choice(letters) for i in range(nhapSoLuongkiTuVaoDiAThong))
...
driver.find_element_by_xpath("//input[@name='pinno']").send_keys("355242")

driver.find_element_by_xpath("//input[@name='emailid']").clear()
driver.find_element_by_xpath("//input[@name='emailid']").send_keys("thong" +y + "@gmail.com")
